...
export const CACHE_NAME = "solstice-full-offline-v81";
const STORAGE_KEY = "solstice-full-offline-v81-complete";
const DISMISSED_KEY = "solstice-full-offline-v81-dismissed";
