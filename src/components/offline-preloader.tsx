...
export const CACHE_NAME = "solstice-full-offline-v66";
const STORAGE_KEY = "solstice-full-offline-v66-complete";
const DISMISSED_KEY = "solstice-full-offline-v66-dismissed";
