...
export const CACHE_NAME = "solstice-full-offline-v89";
const STORAGE_KEY = "solstice-full-offline-v89-complete";
const DISMISSED_KEY = "solstice-full-offline-v89-dismissed";
