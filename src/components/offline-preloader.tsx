...
export const CACHE_NAME = "solstice-full-offline-v76";
const STORAGE_KEY = "solstice-full-offline-v76-complete";
const DISMISSED_KEY = "solstice-full-offline-v76-dismissed";
