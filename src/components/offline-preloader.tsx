...
export const CACHE_NAME = "solstice-full-offline-v67";
const STORAGE_KEY = "solstice-full-offline-v67-complete";
const DISMISSED_KEY = "solstice-full-offline-v67-dismissed";
