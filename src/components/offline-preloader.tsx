...
export const CACHE_NAME = "solstice-full-offline-v78";
const STORAGE_KEY = "solstice-full-offline-v78-complete";
const DISMISSED_KEY = "solstice-full-offline-v78-dismissed";
