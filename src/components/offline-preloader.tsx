...
export const CACHE_NAME = "solstice-full-offline-v61";
const STORAGE_KEY = "solstice-full-offline-v61-complete";
const DISMISSED_KEY = "solstice-full-offline-v61-dismissed";
