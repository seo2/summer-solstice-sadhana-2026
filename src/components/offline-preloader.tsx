...
export const CACHE_NAME = "solstice-full-offline-v77";
const STORAGE_KEY = "solstice-full-offline-v77-complete";
const DISMISSED_KEY = "solstice-full-offline-v77-dismissed";
