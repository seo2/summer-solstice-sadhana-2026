...
export const CACHE_NAME = "solstice-full-offline-v79";
const STORAGE_KEY = "solstice-full-offline-v79-complete";
const DISMISSED_KEY = "solstice-full-offline-v79-dismissed";
