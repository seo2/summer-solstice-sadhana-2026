...
export const CACHE_NAME = "solstice-full-offline-v82";
const STORAGE_KEY = "solstice-full-offline-v82-complete";
const DISMISSED_KEY = "solstice-full-offline-v82-dismissed";
