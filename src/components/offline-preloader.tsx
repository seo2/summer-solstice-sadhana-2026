...
export const CACHE_NAME = "solstice-full-offline-v80";
const STORAGE_KEY = "solstice-full-offline-v80-complete";
const DISMISSED_KEY = "solstice-full-offline-v80-dismissed";
