...
export const CACHE_NAME = "solstice-full-offline-v87";
const STORAGE_KEY = "solstice-full-offline-v87-complete";
const DISMISSED_KEY = "solstice-full-offline-v87-dismissed";
