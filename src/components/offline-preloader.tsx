...
export const CACHE_NAME = "solstice-full-offline-v83";
const STORAGE_KEY = "solstice-full-offline-v83-complete";
const DISMISSED_KEY = "solstice-full-offline-v83-dismissed";
