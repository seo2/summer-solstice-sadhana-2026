...
export const CACHE_NAME = "solstice-full-offline-v90";
const STORAGE_KEY = "solstice-full-offline-v90-complete";
const DISMISSED_KEY = "solstice-full-offline-v90-dismissed";
