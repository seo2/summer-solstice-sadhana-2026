...
export const CACHE_NAME = "solstice-full-offline-v88";
const STORAGE_KEY = "solstice-full-offline-v88-complete";
const DISMISSED_KEY = "solstice-full-offline-v88-dismissed";
