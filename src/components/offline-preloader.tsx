...
export const CACHE_NAME = "solstice-full-offline-v68";
const STORAGE_KEY = "solstice-full-offline-v68-complete";
const DISMISSED_KEY = "solstice-full-offline-v68-dismissed";
