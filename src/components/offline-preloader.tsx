...
export const CACHE_NAME = "solstice-full-offline-v72";
const STORAGE_KEY = "solstice-full-offline-v72-complete";
const DISMISSED_KEY = "solstice-full-offline-v72-dismissed";
