...
export const CACHE_NAME = "solstice-full-offline-v75";
const STORAGE_KEY = "solstice-full-offline-v75-complete";
const DISMISSED_KEY = "solstice-full-offline-v75-dismissed";
