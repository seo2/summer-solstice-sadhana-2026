...
export const CACHE_NAME = "solstice-full-offline-v59";
const STORAGE_KEY = "solstice-full-offline-v59-complete";
const DISMISSED_KEY = "solstice-full-offline-v59-dismissed";
