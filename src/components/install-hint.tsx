...
export function InstallHint() {
  ...
  return (
    <div className="card rounded-3xl p-4">
      ...
      <p className="mt-2 text-sm leading-6 text-stone-700">Open this app once with internet. Then use your browser menu to install it. On iPhone: tap <Share className="inline h-4 w-4" /> Share, then “Add to Home Screen”. Favorites and My Agenda are saved locally on this phone.</p>
    </div>
  );
}
